...
$GLOBALS['TL_DCA']['tl_content']['palettes']['turbo_frame_start'] = '{type_legend},type;{template_legend:hide},customTpl;{protected_legend:hide},protected;{expert_legend:hide},guests,cssID;{invisible_legend:hide},invisible,start,stop';
